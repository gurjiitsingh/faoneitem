...
// export async function deletedelivery(id:string, oldImgageUrl:string) {

//   const result = await db.delete(delivery).where(eq(delivery.id, id));
...
//     } catch (error) {
//      // console.log(error);
//       return {errors:"Somthing went wrong, can not delete delivery picture"}
//     }

//        return {
//       message: { sucess: "Deleted delivery" },
//     };
//   }else{
//     return {errors:"Somthing went wrong, can not delete delivery"}
//   }
